<template>
    <button class="bg-blue-5 w-100% h-44px shadow b-rounded flex items-center max-w-md cursor-pointer b-none p-0" type="button"
        @click="handleGoogleLogin" hover="shadow-blue bg-op-90">
